...
:::: {.column width="50%"}
::: {style="font-size: 0.5em;"}
Here we look at the setlists in one tour: 
-   what are the common, conserved blocks of songs?
...
-   **Data Preparation**
    -   Knowing the data is key for the ability to judge the outcome of the code {.smaller}
    -   Standardizing data types and fixing inconsistencies and errors {.smaller}
-   **Analyses and visualization**
    -   Combining tools (e.g. R, Shiny, bash command-line, Quarto, GitHub) creates a powerful and inspiring environment to extract knowledge and insights from data {.smaller}
-   **Generative AI Support**
    -   Leveraging GenAI for project ideation, code writing/debugging, advising on tools, visuals and platforms, co-designing data management set-up and code deployment strategies {.smaller}
    -   Importance of clear prompts, check for hallucinations and knowing its limits {.smaller}
-   **Data Analytics is Fun**
    -   I thoroughly enjoyed this Capstone Project of the Google Data Certification! {.smaller}
