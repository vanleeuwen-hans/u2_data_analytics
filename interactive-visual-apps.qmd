...
I created an interactive version of the world map so that the user can filter by tour and/or song. This was done with R-Shiny and deployed to shinyapps.io at: [U2 Tour Map](https://qjxo03-hans-van0leeuwen.shinyapps.io/u2_tour_map/).
