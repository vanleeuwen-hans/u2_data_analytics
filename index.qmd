...
The work documented on this site is is my **Capstone Project for the Google Data Analytics Certification program**. The data used in this project was obtained from the excellent online U2 concert resource u2gigs.com. Permission to do so was requested and kindly granted by Matt \@ u2gigs.com. Thank you so much!

This was a very good and exciting experience and taught me a lot of valuable lessons in all the different phases of data analytics: **Ask, Prepare, Process, Analyze, Share and Act**. In addition, during the data visualization part I combined forces with AI assistants (mostly Claude.AI and Perplexity.AI) to troubleshoot the code and to create even better visualizations, e.g. the zoomable, interactive world maps of U2 concert locations over time and the U\@ Setlist Alignment app. A big thank you to my wife who has been on this U2 adventure with me and also provided very valuable feedback and input as I analyzed the data.
