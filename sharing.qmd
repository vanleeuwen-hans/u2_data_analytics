...
flowchart TB
    ...
    classDef shiny fill:#ffffff,stroke:#333,stroke-width:2px
    ...
    MainBranch{{"main branch\n(Quarto docs & code)"}}:::github
    GHPages{{"gh-pages branch\n(rendered website)"}}:::github
